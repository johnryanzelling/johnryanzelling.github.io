# Flipped Classroom Assignment 2 Submission Details

## Assignment Name

Flipped Classroom Assignment 2

## Lesson Title

Unlocking the Pythagorean Theorem: A Flipped Escape-Room Lesson

## Grade/Course

Regular Grade 7 Mathematics - Remedial Pre-Algebra Bridge

## Hosted Lesson URL

Placeholder: add the final public GitHub Pages URL after the site is published and verified.

Expected lesson path within this static site:

`resources/flipped-classroom-assignment-2/flipped-classroom-assignment-2.html`
...
Placeholder: no final Microsoft Forms embed URL or direct URL has been supplied yet.

Configure these fields in `lesson-config.js` when the final survey is ready:

- `media.microsoftFormsSurvey.embedUrl`
- `media.microsoftFormsSurvey.directUrl`
...
Open the final hosted lesson URL and begin with the Before Class section. Proceed through the page in order:

1. Lesson Overview
2. Before Class
3. Teacher-Created Mini Lesson
4. External Videos
5. Guided Notes
6. Readiness Check
7. During Class
8. Pythagorean Escape Room
9. Exit Ticket
10. Student Survey
...
- Prerequisite review and five-item readiness check with local browser progress.
- Accountability and five-minute catch-up directions.
- 60-minute in-class schedule.
...
## Remaining Manual Configuration Items
...
- Confirm Microsoft Forms configured, direct-link-only, and unconfigured states.
- Confirm keyboard-only operation, visible focus, live feedback, reduced-motion support, mobile layout, tablet layout, laptop layout, and desktop layout.
- Confirm browser console contains zero errors.
- Confirm no local-preview URLs, file URLs, Windows filesystem paths, credentials, server dependencies, or stale nested lesson-page references are present.

## Blackboard Submission Comment

Lesson: Unlocking the Pythagorean Theorem: A Flipped Escape-Room Lesson

Grade/Course: Regular Grade 7 Mathematics - Remedial Pre-Algebra Bridge
